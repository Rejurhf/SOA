 ...
 * 2019-04-04T22:00:33+02:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "HelloWorldService",
                  wsdlLocation = "http://localhost:8080/lab-ejb/HelloWorld?wsdl",
                  targetNamespace = "http://soa.agh.edu.pl/")
public class HelloWorldService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://soa.agh.edu.pl/", "HelloWorldService");
    public final static QName HelloWorldPort = new QName("http://soa.agh.edu.pl/", "HelloWorldPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/lab-ejb/HelloWorld?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/lab-ejb/HelloWorld?wsdl");
        }
        WSDL_LOCATION = url;
    }
